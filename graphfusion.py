...
#TODO:TODO:
    ...
    def forward(self, features, indices=[0,2]):
        #TODO:TODO:
        # bs, channel, sinppet_dim, feature_dim
        feature_1, feature_2 = features
        b, c, t, feat_v = feature_1[0].shape
        feat_t = feature_2[1].shape[3]

        # reshape the input features
        fv = feature_1.view(b*c, t, feat_v)
        ft = feature_2.view(b*c, t, feat_t)
